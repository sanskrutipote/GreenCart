...
/**********************************************Sweet Potato******************************************************/
// --- Cart integration for ALL crop modals ---
const cropModals = [
  { btn: 'right-page-buy1', qty: '.qty_value1', name: 'Sweet Potato', price: 200, img: 'Images/sweet-potato.jpg' },
  { btn: 'right-page-buy2', qty: '.qty_value2', name: 'Corn', price: 180, img: 'Images/maize.jpg' },
  { btn: 'right-page-buy3', qty: '.qty_value3', name: 'Wheat', price: 160, img: 'Images/wheat.jpg' },
  { btn: 'right-page-buy4', qty: '.qty_value4', name: 'Potatoes', price: 90, img: 'Images/potatoes.jpg' },
  { btn: 'right-page-buy5', qty: '.qty_value5', name: 'Rice', price: 120, img: 'Images/rice.jpg' },
  { btn: 'right-page-buy6', qty: '.qty_value6', name: 'Vegetables', price: 110, img: 'Images/product-vegetables.jpg' },
  { btn: 'right-page-buy7', qty: '.qty_value7', name: 'Legumes', price: 140, img: 'Images/product-legumes.jpg' },
  { btn: 'right-page-buy8', qty: '.qty_value8', name: 'Pomegranate', price: 210, img: 'Images/pomegranet.jpg' },
  { btn: 'right-page-buy9', qty: '.qty_value9', name: 'Leeks', price: 70, img: 'Images/leeks.jpg' },
  { btn: 'right-page-buy10', qty: '.qty_value10', name: 'Radish', price: 60, img: 'Images/radish.jpg' },
  { btn: 'right-page-buy11', qty: '.qty_value11', name: 'Cauliflower', price: 130, img: 'Images/CAULIFLOWER.jpg' },
  { btn: 'right-page-buy12', qty: '.qty_value12', name: 'Soya Beans', price: 170, img: 'Images/soya-beans.jpg' }
];
document.addEventListener('DOMContentLoaded', function () {
  cropModals.forEach(crop => {
    var btn = document.getElementById(crop.btn);
    if (btn) {
      btn.onclick = function (e) {
        e.preventDefault();
        var qtyInput = document.querySelector(crop.qty);
        ...
        if (typeof window.addToCart === 'function') {
          ...
          // Show the cart popup after adding item
          var cartSection = document.getElementById('cartSection');
          if (cartSection) {
            cartSection.style.display = 'block';
            window.updateCartDisplay && window.updateCartDisplay();
          }
        }
      };
    }
...
// The generic `cropModals` handler at the top handles Buy buttons for all modals.
// Removed the duplicate explicit `right-page-buy` handler to avoid multiple addToCart calls.
/**********************************************Sweet Potato******************************************************/
...
// Cart integration for Sweet Potato modal Buy button (robust for script order)
// Duplicate delayed handler removed — relying on `cropModals` instead.
/**********************************************Corn******************************************************/
