...
%MYSQL_CMD% -u root -p -e "USE finalproject; SELECT '=== MEMBERSHIP TABLE ===' AS ''; SELECT * FROM membership; SELECT '' AS ''; SELECT '=== CONTACT US TABLE ===' AS ''; SELECT * FROM contactus; SELECT '' AS ''; SELECT '=== POSTS TABLE ===' AS ''; SELECT * FROM posts; SELECT '' AS ''; SELECT '=== CROP SALES TABLE ===' AS ''; SELECT * FROM cropsales;"
